...
print(
    star(*ar)
)  # распаковывем список ar для передачи в ф-цию star, ко-во аргументов должно совпадать
...
def count_out1(
    start=0,
):  # Переменная start  в глобальной обл видимости и не стирается при повторных вызовах cl и cl2
...
print(
    cl(*j), cl2(*j)
)  # Распаковали список j, и -> в count_inner1() через *args -> в sum(args) -> вернули f = sum()
