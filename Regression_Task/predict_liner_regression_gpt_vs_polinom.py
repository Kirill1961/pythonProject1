...
X = np.array([[150, 3, 20], [200, 4, 15], [250, 4, 10], [300, 5, 5], [350, 5, 1]])
...
print(
    model.score(x_poly, y), "score - Качество модели, Коэффициент детерминации", "\n"
)  # Качество модели, R**
...
print(
    X_new_poly,
    "        преобразуем 3 три исходных признака [280, 4, 8] в 10 признаков",
    "\n",
)
