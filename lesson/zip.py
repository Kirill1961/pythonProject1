...
i = [1, 2, 100]
print(
    [x for x in map(sum, zip(i, u))],
    " Поэлементное сложение 2х списков 1й вариант",
    "\n",
)
...
print(
    [sum(i[0]) for i in zip(y)], " Сложение значений внутри списков 3-х и болеее", "\n"
)

# Поэлементное сложение 3х и более списков
print(
    [sum(j) for j in [[i[0] for i in y], [i[1] for i in y]]],
    " Поэлементное сложение 3х и более списков",
    "\n",
)
...
print(
    zip(a, b),
    " вывод запакованных элементов с zip без итерации, это адрес ячейки",
    "\n",
)
...
a_b = zip(
    a, b
)  # для обратной перестановки items zip размещаем в переменную, те список мы можем прокрутить обратно

print(
    list(zip(*a_b)),
    " вывод распакованных обратно переставленных элементов  с zip через list >> *a_b",
    "\n",
)
print(
    tuple(zip(a, b)),
    " вывод распакованных обратно переставленных элементов  с zip через t u p l e >>",
    "\n",
)
