...
def minimz(x_data, y_data, l_r):
    ...
    while quantity_iteration_for_g_d < 1000:
        ...
        step_size_for_a_b = [
            grad_for_a_b * l_r * 1 / quantity_iteration_for_g_d
            for grad_for_a_b in s_e_g(data_x_y, theta_0)
        ]
        ...
        quotient_no_improvement = [
            round(theta_0[0], 4) == round(theta_n[0], 4) for _ in range(2)
        ]  # 5-ти кратная проверка равенства theta_0 и theta_n
