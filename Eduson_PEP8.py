...
print(f"k2 = {k2}")
if (
    first_coefficient != 0 and second_coefficient % 2 != 0 and third_coefficient != 0
    ...
    if d > 0:
        ...
        if (-third_coefficient / first_coefficient) < 0:
            print(
                f" -third_coefficient / first_coefficient = : {-third_coefficient / first_coefficient}, т.е. < 0, поэтому действительных корней нет"
            )
if (
    first_coefficient != 0 and third_coefficient == 0 and second_coefficient != 0
):  # решение уравнения при с = 0
    print(
        f"корень уравнения равен либо нулю, либо {-second_coefficient / first_coefficient}"
    )
if (
    first_coefficient != 0 and second_coefficient == 0 and third_coefficient == 0
