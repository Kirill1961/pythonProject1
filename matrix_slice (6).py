...
# Минус - это просто отрицание прежней формы, число с минусом может быть любое.
# Отрицательный аргумент в reshape, означает что надо изменить форму матрицы согласно значению 2-го параметра
#  но в пределах исходного размера матрицы
#  в данном случае преобразуем одномерный массив "а" в 2-х мерный "b",
a = np.array([1, 2, 3, 4, 5, 6])
print(a, "исходный одномерный массив")
b = a.reshape(-1, 1)
print(b, "reshape(-1, 1) - преобразовали в 2-х мерный вектор столбец")
b = a.reshape(3, -1)
print(b, "reshape(3, -1) - или в 2-мерный векор с двумя столбцами  ", "\n")
