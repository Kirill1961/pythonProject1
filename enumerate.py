seq = [
    ...
    "r",
    "q",
]  # присваиваем ОБ списка № или индекс, start=0 - стартовое число №
...
print(
    [a[ind] - b[ind] for ind, _ in enumerate(a)], " Поиндексные действия со списками "
)
...
print(
    [s[k] if sum(s[k]) < sum(s[k + 1]) else None for k, _ in enumerate(s[:-1])],
    " ограничиваем генерацию enumerate "
